...
### 6.7 Email verification Code - Cancel account
...
| --------------------- | ------------------------------------------------------------ |
| Interface Description | Send email verification code                                 |
| Request Path          | {interface address}/{interface version}/organization/sendCaptchaForUnregister |
| Request Method        | POST                                                         |
| Request Type          | application/json                                             |

Request Parameters: (Note: This interface is invoked with a Token)
